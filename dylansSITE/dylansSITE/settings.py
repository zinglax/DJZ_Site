...
DATABASES = {
    'default': {
        ...
        'NAME': PATH_TO_FILE + '/dylans.db',                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ["http://192.168.1.25:8000/", "192.168.1.25:8000"]
...
STATIC_ROOT = ''#PATH_TO_FILE + "/static"
...
STATICFILES_DIRS = (
    ...
    PATH_TO_FILE + "/static",
    #"/home/dylan/Desktop/DJZ_Site/dylansSITE/static",
)
